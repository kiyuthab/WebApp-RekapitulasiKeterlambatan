...
<body>
    <div class="container">
        ...
        <div class="data">
            ...
            <table>
                <tr><td>NIS</td><td>:</td> <td>{{ $lates->student->nis }}</td></tr>
                <tr><td>Nama</td><td>:</td> <td>{{ $lates->student->name }} </td></tr>
                <tr><td>Rombel</td><td>:</td> <td>{{ $lates->student->rombel->rombel }}</td> </tr>
                <tr><td>Rayon</td><td>:</td> <td>{{ $lates->student->rayon->rayon }}</td></tr>
            </table>
        </div>
