                    ...
                    <tbody>
                        ...
                        @foreach ($rekap as $item)
                            <tr>
                                ...
                                <td>{{ $item['total'] }}</td>
                                <td><a href="{{ route('ps.late.detail', ['id' => $item->student_id]) }}"
                                        class="text-blue-500 hover:text-blue-700">Lihat</a></td>
                                <td>
                                    @if ($item->total >= 3)
                                        <a class="btn btn-danger btn-sm text-white hover:bg-red-800 display-flex"
                                            href="{{ route('ps.late.print', ['id' => $item->student_id]) }}">Surat
                                            Pernyataan</a>
                                    @endif
                                </td>
                            </tr>
