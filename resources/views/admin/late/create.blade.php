...
@section('content')
    ...
    <div class="title" style="margin: 4px 15px; ">
        ...
        <a href="/home">Dashboard / </a><a href="{{ route('late.home') }}"
            class="link-offset-2 link-underline link-underline-opacity-0 text-blue"> Data Keterlambatan / </a><a
            class="link-offset-2 link-underline link-underline-opacity-0 text-black">Tambah Data Keterlambatan</a>
    </div><br>
